        ...
        <div className='grid grid-flow-col grid-cols-3 bg-white h-full min-h-screen w-full'>
          ...
          <div className='flex justify-start col-span-2 '>
            <div className='mx-16 pt-10 w-full flex flex-col gap-y-4'>
              ...
              <Carousel>
                <CarouselContent>
                  <CarouselItem className="basis-1/3 w-72 h-72"><img className='object-cover w-full h-full' src="https://media.kijiji.ca/api/v1/ca-prod-fsbo-ads/images/e7/e779ba9c-4702-4519-aa5c-236fae8a3b98?rule=kijijica-640-webp" alt="" /></CarouselItem>
                  <CarouselItem className="basis-2/3 w-72 h-72"><img className='object-cover w-full h-full' src="https://media.kijiji.ca/api/v1/ca-prod-fsbo-ads/images/14/148138da-e0c0-4018-8c52-fce84999b9df?rule=kijijica-640-webp" alt="" /></CarouselItem>
                  <CarouselItem className="basis-3/3 w-72 h-72"><img className='object-cover w-full h-full' src="https://media.kijiji.ca/api/v1/ca-prod-fsbo-ads/images/f3/f3fea19f-79c6-48de-a8df-8a01a01e286f?rule=kijijica-640-webp" alt="" /></CarouselItem>
                </CarouselContent>
                <CarouselPrevious />
                <CarouselNext />
              </Carousel>
